...
void LedStrip::begin(void) {
  ...
  FastLED.addLeds<LED_TYPE, DATA_PIN7, COLOR_ORDER>(leds[6], MaxLedsPerStrip).setCorrection(CRGB(BRIGHTNESS_PIN6,BRIGHTNESS_PIN7,BRIGHTNESS_PIN7) );
  FastLED.addLeds<LED_TYPE, DATA_PIN8, COLOR_ORDER>(leds[7], MaxLedsPerStrip).setCorrection(CRGB(BRIGHTNESS_PIN6,BRIGHTNESS_PIN8,BRIGHTNESS_PIN8) );
